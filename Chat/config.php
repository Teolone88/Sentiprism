...
$dbss['name']='senti';      // Database name. Note that the installation script cannot create a database for you!
$dbss['sock']='';      // Database socket
$dbss['prfx']='chat';      // Table prefix for chat tables: blab, blabws, blabax, blabwspro

$dbss['sprf']='chat';      /* Table prefix for shared chat tables (this should be the table prefix of the 'master' channel). 
...
$xcookie_uidhash = array('chat_uidhash',31536000);       // cookie to recognize logged in users
$xcookie_options = array('chat_options',31536000);       // cookie to store options
$xcookie_options = array('chat_soption',31536000);       // cookie to store sound settings
$xcookie_ignored = array('chat_ignored',172800);         // cookie to store ignored users
$xcookie_message = array('chat_annread',31536000);       // cookie to indicate announce (GDPR notice) is read
$xcookie_appcode = array('chat_appcode',31536000);       // cookie to BlaB! Q mobile app (integration only!)
