...
//    endif;
    ...
    $mainArray = [];
    $mainArray[] = ['Task', 'Hours per Day'];
    $mainArray[] = ['Happy', $mood_1];
    $mainArray[] = ['Sad', $mood_2];
    $mainArray[] = ['Tender', $mood_3];
    $mainArray[] = ['Satisfied', $mood_4];
    $mainArray[] = ['Energetic', $mood_5];
